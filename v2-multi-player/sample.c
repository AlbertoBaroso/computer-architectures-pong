...
int main(void) {
    ...
    timer0_time = 0x98968;
		...
		timer2_time = 0x4C4B40;
    #ifdef SIMULATOR
        timer0_time = 25000000 / ball_refresh; 
				timer1_time = 25000000 / paddle_user_refresh;
				timer2_time = 25000000 / paddle_cpu_refresh;
    #endif
    ...
    init_timer(1, timer1_time, 0);    // Timer 1: User Paddle movement
    init_timer(2, timer2_time, 0);    // Timer 2: CPU Paddle movement
